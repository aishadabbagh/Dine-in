...
Food.create(name: "Lusin", price: 0, image: "https://media-cdn.tripadvisor.com/media/photo-s/04/c5/88/5f/lusin.jpg", restaurant_id: Restaurant.ids[0])
Food.create(name: "Lusin", price: 0, image: "https://cdn.theculturetrip.com/images/56-249025-lusin.jpg", restaurant_id: Restaurant.ids[0])
...
Food.create(name: "Al Orjouan", price: 0, image: "https://s7d2.scene7.com/is/image/ritzcarlton/50556723-RUHRZ_2018_0750?$XlargeViewport100pct$", restaurant_id: Restaurant.ids[1])
Food.create(name: "Al Orjouan", price: 0, image: "https://s7d2.scene7.com/is/image/ritzcarlton/50556724-RUHRZ_2018_0771?$XlargeViewport100pct$", restaurant_id: Restaurant.ids[1])
...
Food.create(name: "Zafran Indian Bistro", price: 0, image: "https://www.zafranrestaurants.com/sites/default/files/website-gallery4-%28850x500px%29_0.jpg", restaurant_id: Restaurant.ids[2])
Food.create(name: "Zafran Indian Bistro", price: 0, image: "https://www.zafranrestaurants.com/sites/default/files/website-gallery-%289850x500px%29_0.jpg", restaurant_id: Restaurant.ids[2])
